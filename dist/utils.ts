import { Task, FileData } from "./index.ts";
...
export type ThroughCallback = TransformStreamDefaultControllerTransformCallback<
  FileData,
  FileData
>;
...
export function through(transform: ThroughCallback) {
